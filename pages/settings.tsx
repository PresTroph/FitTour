...
export default function SettingsPage() {
  ...
  return (
    <main className="min-h-screen max-w-xl mx-auto p-6 bg-gray-50">
      <h1 className="text-2xl font-bold mb-4">Account Settings</h1>

      <p className="text-gray-700 mb-4">
        <strong>Logged in as:</strong> {session?.user?.email || session?.user?.phone}
      </p>
      ...
      <div className="mt-6">
        ...
        <a
          href="https://billing.stripe.com/p/login" // Optional: Replace with Stripe Customer Portal link
          target="_blank"
